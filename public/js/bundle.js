...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWluaGJ1aSIsImEiOiJjazRhcW5zYmowNjhoM2x1cTB3aXM0N3ZmIn0.rBnhirpCIyzIS-B0bSg23Q';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/minhbui/ck4aqr26k0y7s1blligtmujch',
    scrollZoom: false //   center: [-112.987418, 37.198125],
    //   zoom: 10,
    //   interactive: false
